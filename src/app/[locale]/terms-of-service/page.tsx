...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Silent Hill Townfall Wiki",
    description: "Read the Terms of Service for Silent Hill Townfall Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our fan resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Silent Hill Townfall Wiki",
      description: "Terms and conditions for using Silent Hill Townfall Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Silent Hill Townfall Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Silent Hill Townfall Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Silent Hill Townfall Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Silent Hill Townfall Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to "Silent Hill Townfall". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Release date, platform, and edition tracking</li>
              <li>CRTV, puzzle, and combat guides</li>
              <li>Story, character, and location explainers</li>
              <li>Ending and choice coverage</li>
              <li>Official media and store link references</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Silent Hill Townfall Wiki is NOT affiliated with, endorsed by, or associated with
              KONAMI, Annapurna Interactive, Screen Burn, PlayStation, Steam, Epic Games, or the official developers of Silent Hill Townfall. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Silent Hill Townfall Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of their respective owners, including KONAMI and related rights holders for Silent Hill Townfall. We use such
            ...
            <p>
              The Website may contain links to third-party websites, including KONAMI, PlayStation Store, Steam, Epic Games Store, YouTube, X, Reddit, and other social platforms,
            ...
            <p>
              ...
              you and Silent Hill Townfall Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@silent-hill-townfall.wiki</a>
            </p>
            <p>
