...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://silent-hill-townfall.wiki'
  const path = '/about'

  return {
    title: 'About Silent Hill Townfall Wiki - Fan Resource Hub',
    description: 'Learn about Silent Hill Townfall Wiki, a community-driven resource hub covering release info, CRTV mechanics, story clues, and official links for Silent Hill Townfall.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'About Silent Hill Townfall Wiki',
      description: 'Learn about our mission to provide the best Silent Hill Townfall resource hub.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          alt: 'Silent Hill Townfall Wiki',
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Silent Hill Townfall Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Silent Hill Townfall
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Silent Hill Townfall Wiki</h2>
            <p>
              Silent Hill Townfall Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              track and understand "Silent Hill Townfall". We are a community-driven platform that provides release coverage,
              CRTV explainers, story references, ending notes, and official link roundups to enhance your experience with the game.
            </p>
            <p>
              ...
              Silent Hill Townfall Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Silent Hill Townfall players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Silent Hill Townfall Wiki as the <strong>go-to destination</strong> for every Silent Hill Townfall player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Silent Hill Townfall Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Silent Hill Townfall Wiki is maintained by a dedicated team of passionate horror fans and developers who love
              Silent Hill as much as you do. We're players first, constantly testing theories, tracking updates, and exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Silent Hill Townfall mechanics, story clues, and player concerns</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Silent Hill Townfall Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with KONAMI, Annapurna Interactive, Screen Burn, or any official entities.
            </p>
            <p>
            ...
            <p>
              Silent Hill Townfall Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@silent-hill-townfall.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@silent-hill-townfall.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@silent-hill-townfall.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@silent-hill-townfall.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest release updates, trailers, and Silent Hill Townfall coverage.
