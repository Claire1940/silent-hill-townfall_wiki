...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Silent Hill Townfall Wiki',
    description: 'Silent Hill Townfall Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Silent Hill Townfall fan resource platform.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Silent Hill Townfall Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including KONAMI, PlayStation Store, Steam, Epic Games Store, YouTube, X, Reddit, and other social media platforms.
            ...
            <ul>
              ...
              <li><strong>Hosting Provider:</strong> Website hosting and CDN services</li>
            </ul>
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Silent Hill Townfall Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with KONAMI, Annapurna Interactive, Screen Burn, PlayStation, Steam, Epic Games, or the official Silent Hill Townfall publishers and developers. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@silent-hill-townfall.wiki</a>
            </p>
            <p>
