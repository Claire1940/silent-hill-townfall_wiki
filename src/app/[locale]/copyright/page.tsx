...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Silent Hill Townfall Wiki',
    description: 'Copyright and intellectual property information for Silent Hill Townfall Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Silent Hill Townfall Wiki',
      description: 'Copyright and intellectual property information for Silent Hill Townfall Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Silent Hill Townfall Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Silent Hill Townfall Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Silent Hill Townfall Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>KONAMI</strong> - Silent Hill IP owner and publisher</li>
              <li><strong>Annapurna Interactive</strong> - Publishing partner</li>
              <li><strong>Screen Burn</strong> - Developer of Silent Hill Townfall</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>SILENT HILL</strong> - Trademark of KONAMI</li>
              <li><strong>SILENT HILL TOWNFALL</strong> - Trademark and branding of its respective rights holders</li>
              <li><strong>Silent Hill Townfall Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Silent Hill Townfall Wiki.
            </p>
            ...
            <p>
              ...
              Silent Hill Townfall Wiki<br />
              Email: <a href="mailto:dmca@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@silent-hill-townfall.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Silent Hill Townfall Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Silent Hill Townfall Wiki (silent-hill-townfall.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@silent-hill-townfall.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@silent-hill-townfall.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@silent-hill-townfall.wiki</a>
            </p>
            <p>
